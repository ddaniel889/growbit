...
//import AdminWithdraws from "../views/admin/AdminWithdraws.vue";
...
const ProfilePayment = () => import("../views/profile/ProfilePayment");//  
...
const AdminTransactions = () =>
  ...
  import(
    /* webpackChunkName: "group-admin" */ "../views/admin/AdminWithdraws.vue"
  );
const AdminBanners = () =>
  import(
