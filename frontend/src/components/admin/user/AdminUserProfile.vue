<template>
  <div class="admin-user-profile">
    ...
    <div
      v-if="
        modalsData.user &&
        modalsData.user.affiliates &&
        modalsData.user.affiliates.referrer &&
        modalsData.user.affiliates.referrer.username
      "
      class="profile-date"
    >
...
export default {
  ...
  computed: {
    ...
    banned() {
      if (!this.modalsData.user.ban || !this.modalsData.user.ban.expire) {
        return null;
      }
    ...
    muted() {
      if (!this.modalsData.user.mute || !this.modalsData.user.mute.expire) {
        return null;
      }
