<template>
  <div class="admin-affiliates-element">
    <div class="element-section section-user">
      ...
      <div class="section-content">
        <div class="content-avatar">
          <AvatarImage :avatarNumber="affiliate.avatar" />
        </div>
        <div v-html="affiliate.username" class="content-username"></div>
        <div class="content-rank" v-bind:class="['rank-' + affiliate.rank]">
          {{ affiliate.rank.toUpperCase() }}
        </div>
      </div>
    </div>
    ...
    <div class="element-section section-earned">
      <div class="section-title">Claimed</div>
      <div class="section-content">
        <img src="@/assets/images/sc_icon.png" alt="icon" />
        <div class="content-value">
          <span>{{ adminFormatValue(affiliate.affiliates.totalClaimed) }}</span>
        </div>
      </div>
    </div>
