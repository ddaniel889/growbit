  ...
  <div class="modal-fair-seed">
    ...
    <div v-if="mode === 'SEEDS'" class="content">
      ...
      <div class="seed-element">
        ...
        <div class="element-content">
          <span v-if="userSeedData.data !== null">{{
            (userSeedData.data.seedNext && userSeedData.data.seedNext.hash) ||
            ""
          }}</span>
          <button
            v-on:click="
              modalCopyButton(
                (userSeedData.data.seedNext &&
...
export default {
  ...
  methods: {
    ...
    changeSeed() {
      let seedClient =
        (this.modalClientSeed && this.modalClientSeed.trim()) || "";
      if (!seedClient) {
        this.notificationShow({
          type: "error",
    ...
    output() {
      if (this.game === "mines") {
        ...
        return this.verifyPlinko(
          this.plinkoRows,
          (this.plinkoRisk && this.plinkoRisk.toLowerCase()) || ""
        );
