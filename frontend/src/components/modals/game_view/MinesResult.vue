  ...
  <div v-if="game" :class="'mines_grid_res-' + game.gridSize">
    <div
      ...
      :class="`cell ${
        ...
        markNotRevealed &&
        game.revealed &&
        game.revealed.find((r) => r.tile === i - 1)
          ? 'revealed'
          : ''
      }`"
    >
      <img
        v-if="game.deck && game.deck[i - 1] === 'mine'"
        class="bomb"
        alt
        src="../../../assets/images/mines/bomb.webp"
      />
      <img
        v-if="game.deck && game.deck[i - 1] === 'coin'"
        alt
...
export default {
  ...
  computed: {
    markNotRevealed() {
      return this.game && this.game.revealed && this.game.revealed.length;
    },
  },
  watch: {},
  methods: {},
