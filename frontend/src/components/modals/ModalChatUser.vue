  ...
  <div class="modal-chat-user">
    ...
    <div class="inner">
        ...
        <div class="user-info">
          ...
          <div class="nameAndJoin">
            ...
            <div class="join">
              <span>Join Date:</span>
              <span>{{
                generalUserInfo.data && generalUserInfo.data.createdAt
                  ? new Date(
                      generalUserInfo.data.createdAt
                    ).toLocaleDateString()
                  : ""
              }}</span>
            </div>
      ...
      <div v-if="!isYou" class="action-buttons">
        ...
        <button
          v-if="
            this.generalUserInfo &&
            this.generalUserInfo.data &&
            this.generalUserInfo.data.rank !== 'admin'
          "
          class="btn"
          @click="ignoreUser()"
        >
...
export default {
  ...
  computed: {
    ...
    levelInfo() {
      return getUserLevel(this.generalUserInfo && this.generalUserInfo.data);
    },
    isAdmin() {
      return (
        this.authUser &&
