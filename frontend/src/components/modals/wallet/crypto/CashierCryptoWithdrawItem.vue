...
export default {
  ...
  methods: {
    ...
    onAmountInput() {
      const price =
        this.cashierCryptoData &&
        this.cashierCryptoData.prices &&
        this.cashierCryptoData.prices[this.currencyName.toUpperCase()] &&
        this.cashierCryptoData.prices[this.currencyName.toUpperCase()].price;
      if (price) {
  ...
  computed: {
    ...
    currencyName() {
      return this.currency.split(/[()]/)[0].trim().toUpperCase();
    },
    cashierGetName() {
    ...
    currencyInfo() {
      ...
      if (
        this.cashierCryptoData &&
        this.cashierCryptoData.prices &&
        this.cashierCryptoData.prices[this.currencyName] &&
        this.cashierCryptoData.prices[this.currencyName].info &&
        this.cashierCryptoData.prices[this.currencyName].info.networkList
      ) {
        const networkList = Object.values(
          this.cashierCryptoData.prices[this.currencyName].info.networkList
        );
      ...
      const price =
        ...
        this.cashierCryptoData.prices &&
        this.cashierCryptoData.prices[this.currencyName] &&
        this.cashierCryptoData.prices[this.currencyName].price;
      ...
      return {
        fee: fee ? fee.toFixed(2) : fee,
        minWithdraw: minWithdraw ? minWithdraw.toFixed(2) : minWithdraw,
      };
    },
  },
};
