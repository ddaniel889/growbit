...
const getters = {
  ...
  adminWithdrawsList: (state) => state.adminWithdrawsList,
...
const mutations = {
  ...
  admin_set_withdraws_list(state, data) {
    state.adminWithdrawsList.data = data.transactions;
    state.adminWithdrawsList.count = data.count;
  },
  admin_set_transaction_list_loading(state, status) {
    state.adminTransactionList.loading = status;
  },
  admin_set_withdraws_list_loading(state, status) {
    state.adminWithdrawsList.loading = status;
  },
  admin_set_transaction_list_page(state, page) {
    state.adminTransactionList.page = page;
  },
  admin_set_withdraws_list_page(state, page) {
    state.adminWithdrawsList.page = page;
  },
  admin_set_user_transaction_list(state, data) {//AQUIIIIII
