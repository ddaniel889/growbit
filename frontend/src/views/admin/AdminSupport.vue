  ...
  computed: {
    ...
    currentChatObj() {
      if (this.selectedChatUserId) {
        if (!this.adminSupportChats.chats) return null;
...
<template>
  <div class="container">
    ...
    <span
      v-if="
        !adminSupportChats.loading &&
        (!adminSupportChats.chats || !adminSupportChats.chats.length)
      "
      class="no_tickets"
    >
      No Chats yet !
    ...
    <div v-else class="box">
        ...
        <ol>
          <div
            ...
            :class="{
              selected:
                selectedChatUserId &&
                selectedChatUserId.toString() === chat.user.toString(),
            }"
            :key="chat.username"
          >
      ...
      <div class="right">
        <SupportChat
          ...
          :onSend="
            (msg) => {
              sendMessage(msg, currentChatObj && currentChatObj.user);
            }
          "
        ></SupportChat>
      </div>
